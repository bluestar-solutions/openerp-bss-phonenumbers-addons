...
class test_crm_phonenumbers(common.SingleTransactionCase):
    ...
    def test_00_crm_phone(self):
        ...
        self.assertEqual(self.lead.phone, '+1 954-555-1234', 'Lead phone formatting failed')

    def test_10_crm_mobile(self):
        """ I check the stored mobile is correctly formatted for en_US (default). """
        self.assertEqual(self.lead.mobile, '+1 732-757-2923', 'Lead mobile formatting failed')

    def test_20_crm_fax(self):
        """ I check the stored fax is correctly formatted for en_US (default). """
        self.assertEqual(self.lead.fax, '+1 202-268-4871', 'Lead fax formatting failed')
